...
export const postDetail: DetailProps = {
  ...
  date: "2024-10-15",
  content:
    "This document provides a comprehensive introduction to the basics of machine learning, covering core concepts, algorithms, and their applications.",
  documents: [
  ...
  comments: [
    {
      ...
      date: "2024-10-16",
      content:
        "Great introduction! This really helped me understand the fundamentals.",
    },
    {
      id: 102,
      author: {
      ...
      date: "2024-10-17",
      content:
        "Very helpful document! Could you also cover some advanced topics?",
    },
  ],
};
