...
import { Typography, Button, Paper, Avatar, Stack, InputBase, Divider, Box } from '@mui/material';
    ...
    return (
        <Stack sx={{ p: 2 }}>
            <Stack sx={{
                ...
                <Avatar sx={{ width: 80, height: 80 }} src='https://randomuser.me/api/portraits/women/10.jpg' />
